...
print("\n" + "=" * 90)
print("5-fold GroupKFold benchmark on POOL (Transformer baseline, MSE only)")
print("=" * 90)
...
cv_csv_path = os.path.join(RESULTS_DIR, "Transformer_MF60_cv_5fold_baseline_metrics.csv")
...
speed_csv_path = os.path.join(RESULTS_DIR, "Transformer_MF60_test_metrics_by_speed_mean.csv")
...
# =========================================================
ckpt_path = os.path.join(SAVE_DIR, "Transformer_MF60.pt")
...
torch.save({
    ...
    "protocol": "Subject-holdout TEST + 5-fold GroupKFold benchmark on POOL; baseline Transformer; MSE only; report subject-mean metrics; raw target unit=N; model target unit=N/kg",
