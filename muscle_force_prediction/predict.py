...
# -*- coding: utf-8 -*-
"""
Run prediction with trained Gait2Hip-60 MF60 models and save results as CSV.
...
- The original NPZ target unit is N.
- The model was trained on body-weight-normalized targets, so the default
  prediction unit is N/kg.
- Use --save_raw_unit to additionally save predictions restored to N.
...
DEFAULT_NPZ_PATH = REPO_ROOT / "data" / "Gait2Hip_MF60.npz"
DEFAULT_MODEL_PATH = THIS_DIR / "trained_models" / "Transformer_MF60.pt"
DEFAULT_OUTPUT_DIR = THIS_DIR / "predictions"

TASK_NAME = "right hip-related muscle force prediction"
DATASET_ID = "MF60"
RAW_UNIT = "N"
MODEL_UNIT = "N/kg"
...
def main() -> None:
    ...
    parser.add_argument("--npz_path", type=str, default=str(DEFAULT_NPZ_PATH), help="Path to Gait2Hip_MF60.npz.")
