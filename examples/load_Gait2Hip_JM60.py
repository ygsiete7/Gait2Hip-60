...
# Users should download Gait2Hip_JM60.npz from Zenodo and place it in the data/ folder.
NPZ_PATH = Path(__file__).resolve().parents[1] / "data" / "Gait2Hip_JM60.npz"
...
def main():
    """Load and inspect the Gait2Hip_JM60 dataset."""

    if not NPZ_PATH.exists():
        raise FileNotFoundError(
            f"File not found: {NPZ_PATH}\n"
            "Please download Gait2Hip_JM60.npz from Zenodo and place it in the data/ folder."
        )
    ...
    print("\nDataset: Gait2Hip_JM60")
    print("Task: Right hip joint moment prediction")
    ...
    print(f"\nPreview of joint moment outputs for trial {trial_idx}:")
    print(df_Y.head())
