...
print("\n" + "=" * 90)
print("5-fold GroupKFold benchmark on POOL (Mamba baseline, MSE only, moment prediction)")
print("=" * 90)
...
cv_csv_path = os.path.join(RESULTS_DIR, "Mamba_JM60_cv_5fold_baseline_metrics.csv")
...
speed_csv_path = os.path.join(RESULTS_DIR, "Mamba_JM60_test_metrics_by_speed_mean.csv")
...
# =========================================================
ckpt_path = os.path.join(SAVE_DIR, "Mamba_JM60.pt")
...
torch.save({
    ...
    "protocol": "Subject-holdout TEST + 5-fold GroupKFold benchmark on POOL; baseline Mamba; MSE only; moment prediction in Nm/kg; report subject-mean metrics; raw target unit=Nm; model target unit=Nm/kg",
